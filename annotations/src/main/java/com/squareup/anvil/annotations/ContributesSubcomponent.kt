 ...
 * component interface for the final generated subcomponent with an abstract factory method for the
 * subcomponent. If you create your own parent component interface, then the one generated by Anvil
 * will extend your interface. E.g.
 * ```
 * @ContributesSubcomponent(
 *   scope = ActivityScope::class,
 *   parentScope = AppScope::class
...
public annotation class ContributesSubcomponent(
   ...
   * parent component interface will return a type of the factory and not the subcomponent directly.
   */
