...
public class AnvilFirContext(
  ...
  private val componentArray =
    object : ComponentArrayOwner<AnvilSessionComponent, AnvilSessionComponent>() {
      override val typeRegistry: ConeTypeRegistry<AnvilSessionComponent, AnvilSessionComponent>
        get() = Companion
    }
